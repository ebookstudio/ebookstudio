...
const NewEbookStudioPage: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-zinc-950 text-zinc-100 overflow-hidden selection:bg-zinc-100/10 selection:text-zinc-100 font-sans relative z-[100]">
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative min-h-0">
            ...
            <aside className={cn(
                "lg:w-[380px] shrink-0 lg:h-full bg-zinc-950 lg:border-r border-zinc-900/50 flex flex-col shadow-[20px_0_60px_rgba(0,0,0,0.5)] transition-all duration-300",
...
export default NewEbookStudioPage;
