            ...
            <div className="w-full max-w-[400px] space-y-8 animate-fade-in">
                ...
                <div className="bg-zinc-900 border border-border p-8 rounded-xl shadow-2xl space-y-6">
                    <Button 
                        ...
                        variant="outline"
                        className="w-full h-11 border-zinc-800 bg-zinc-950 text-zinc-200 hover:bg-zinc-900 text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-3"
                    >
